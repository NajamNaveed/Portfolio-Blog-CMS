...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-28 sm:gap-36">
      {/* Hero */}
      <section className="relative flex flex-col items-start gap-7 py-6 sm:py-14">
        <div className="pointer-events-none absolute -right-24 -top-24 -z-10 size-72 rounded-full bg-accent/10 blur-[100px] sm:size-96" />
        ...
        <motion.h1
          ...
          className="font-display text-5xl font-medium leading-[1.05] tracking-tight text-balance sm:text-7xl"
        >
          {hero?.headline}
        </motion.h1>
